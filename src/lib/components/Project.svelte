<script>
export let name = "Zapasy a vysledky";
export let shortDescription = "Super cool projekt o sledovani vysledku zapasu";
export let description = "Super cool projekt o sledovani vysledku zapasu";
export let image = "https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png";
export let githubLink = "www.github.com";
export let skills = [{
